...
class ControllerVin {
    ...
    // --- Liste des vins
    public static function vinReadAll($args) {
    ...
    public static function vinCreate($args) {
        // ----- Construction chemin de la vue
        include 'config.php';
    ...
    public static function vinCreated($args) {
    ...
    // Affiche le formulaire de suppression d'un vin
